        ...
        <div>
          ...
          <form action="" className="mt-4 flex">
            <input
              ...
              className="w-full p-2 rounded-l-md text-gray-200 focus:outline-none focus:ring-1 focus:ring-gray-500"
            />
            <button
              type="submit"
              className="bg-red-600 text-white px-4 w-fit rounded-r-md hover:bg-red-700"
            >
              Subscribe
            </button>
          </form>
